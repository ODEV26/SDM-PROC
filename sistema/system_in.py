...
video_path = 0  # Cambiar a 0 para usar la cámara web
save_folder = "./static/imgs/Vehiculos/"
...
interval_matriculas = 7  # Intervalo de tiempo en segundos entre cada impresión de matrícula
    ...
    for contour in contours:
        ...
        if area > 1000:
            ...
            if 2.5 < aspect_ratio < 4.0:
                ...
                # Validar que el texto sea una cadena de texto válida y tenga al menos 7 caracteres antes de guardarlo
                if isinstance(plate_text, str) and plate_text.isalpha() and len(plate_text) >= 7:
                    ...
                    if elapsed_since_last_print >= interval_matriculas:
                        ...
                        counter += 1  # Incrementar el contador solo si se guarda la matrï¿½cula

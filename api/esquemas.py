...
# Define la función matriculasEsquema
def matriculasEsquema(matriculas) -> list[dict]:
    ...
    # Recorre cada matrícula en la lista de diccionarios
    for matricula in matriculas_list:
        ...
        formatted_matricula = {
            ...
            "fecha_hora_entrada": matricula["fecha_hora_entrada"],# Sin necesidad de analizar nuevamente si "fecha_hora" ya es un objeto datetime
    ...
    # Retorna la lista de matrículas formateadas
